class CfgPatches
{
	class swla_bl
	{
		...
		units[] = 
		{
			"bl_swla_unit_rifleman_dc15a",
			"bl_swla_unit_engineer_dc15a",
			"bl_swla_unit_medic_dc15a",
			
			"bl_swla_p2_headgear_1",
		};
		weapons[]={};
	};
};
...
class CfgWeapons
{
	...
	class bl_nvg: Integrated_NVG_F
	{
		scope = 1;
		visionMode[] = {"Normal", "NVG"};
		modelOptics = "\SWLB_clones\SWLB_clone_nvg_optic_dummy.p3d";
	};
	class bl_nvg_ti: Integrated_NVG_F
	{
		scope = 1;
	...
	class bl_swla_uniform_base: U_I_CombatUniform
	{
		...
		class ItemInfo: UniformItem
		{
			...
			mass = 40;
			uniformType = "Neopren";
			uniformClass = "bl_swla_unit_base";
		};
	};
	class bl_swla_uniform_mc_base: U_I_CombatUniform
	{
		author="kripto202";
		scope=0;
		...
		{
			uniformModel="-";
			uniformClass="bl_swla_unit_mc_base";
			containerClass="Supply200";
			uniformType = "Neopren";
			mass=40;
		};
	...
	class bl_swla_p2_helmet_base: H_HelmetO_ViperSP_hex_F
	{
		author = "kripto202";
		displayname = "[bl] P2 helmet";
		scope = 0;
		scopeCurator = 0;
		scopeArsenal = 0;
	...
	class bl_swla_p15_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone ARC trooper helmet";
		subItems[] = {};
	...
	class bl_swla_airborne_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_ab_helmet_ca.paa";
		displayname = "[bl] Clone trooper airborne helmet";
		subItems[] = {"bl_nvg"};
	...
	class bl_swla_pilot_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone pilot P2 helmet";
		subItems[] = {"bl_nvg"};
	...
	class bl_swla_barc_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper BARC helmet";
	...
	class bl_swla_arf_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper ARF helmet";
		subItems[] = {"bl_nvg"};
	...
	class bl_swla_eng_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper engineer helmet";
		subItems[] = {"bl_nvg"};
		hiddenSelections[]=
		{
			"camo1",
	...
	class bl_swla_p1_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper P1 helmet";
	...
	class bl_swla_p1_pilot_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper P1 pilot helmet";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_helmet_p1_ca.paa";
	...
	class bl_swla_p1_specops_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper P1 Special Activities Helmet";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_helmet_p1_ca.paa";
	...
	class bl_swla_p2_specops_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper P1 Special Activities Helmet";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_helmet_p1_ca.paa";
	...
	class bl_swla_rex_helmet_base: bl_swla_p2_helmet_base
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper Rex Helmet";
	...
	class bl_swla_vest_base: V_PlateCarrier1_rgr
	{
		author = "kripto202";
		displayname = "[bl] Clone trooper vest";
		scope = 0;
		scopeCurator = 0;
		scopeArsenal = 0;
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_uniform_ca.paa";
	...
	class bl_swla_airborne_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone trooper airborne vest";
	...
	class bl_swla_medic_vest_base: bl_swla_vest_base
	{
		displayName = "[bl] Clone trooper medic vest";
	...
	class bl_swla_cfr_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone trooper CFR vest";
	...
	class bl_swla_recon_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone trooper Recon vest";
	...
	class bl_swla_arc_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone ARC trooper vest";
	...
	class bl_swla_assault_vest_base: bl_swla_vest_base
	{
		displayName = "[bl] Clone trooper assault vest";
	...
	class bl_swla_grenadier_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone trooper grenadier vest";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_light_armor_ca.paa";
	...
	class bl_swla_specialist_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone trooper specialist vest";
		picture="\SWLB_clones\data\ui\icon_SWLB_clone_light_armor_ca.paa";
	...
	class bl_swla_kama_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone trooper kama";
	...
	class bl_swla_officer_vest_base: bl_swla_vest_base
	{
	...
	class bl_swla_commander_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone trooper commander vest";
	...
	class bl_swla_airborne_cfr_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone airborne CFR vest";
	...
	class bl_swla_airborne_light_vest_base: bl_swla_vest_base
	{
		displayname = "[bl] Clone airborne light vest";
	...
	class bl_swla_airborne_officer_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone airborne officer vest";
	...
	class bl_swla_arf_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone ARF vest";
	...
	class bl_swla_heavy_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone heavy vest";
	...
	class bl_swla_heavy_gunner_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone heavy gunner vest";
	...
	class bl_swla_recon_survival_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone recon survival vest";
	...
	class bl_swla_force_recon_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone force recon vest";
	...
	class bl_swla_force_recon_nco_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone force recon nco vest";
	...
	class bl_swla_force_recon_commander_vest_base: bl_swla_vest_base
	{
		displayName="[bl] Clone force recon Commander vest";
	...
	class NVGoggles;
	class bl_clone_nvg_base: NVGoggles
	{
		ace_nightvision_bluRadius = 0.15;
		ace_nightvision_generation = 4;
		scope = 0;
		author = "kripto202";
		displayname = "[bl] Clone Trooper NV Visor";
		modeloptics = "\SWLB_clones\SWLB_clone_nvg_optic_dummy.p3d";
	...
	class bl_clone_rangefinder_base: bl_clone_nvg_base
	{
		displayname = "[bl] Clone trooper rangefinder";
	...
	class bl_clone_commander_visor_base: bl_clone_nvg_base
	{
		displayName="[bl] Clone trooper commander visor";
	...
	class bl_clone_p1_nvg_base: bl_clone_nvg_base
	{
		displayname = "[bl] Clone Trooper P1 NV Visor";
	...
	class bl_clone_p1_rangefinder_base: bl_clone_rangefinder_base
	{
		displayname = "[bl] Clone trooper rangefinder";
...
class CfgVehicles
{
	...
	/* class bl_swla_unit_base: SWLB_clone_base_P2
	{
		scope = 1;
		scopeCurator = 1;
		scopeArsenal = 1;
		...
		author = "kripto202";
		uniformclass = "bl_swla_uniform_base";
		faction = "bl_sod";
		editorSubCategory = "swla_bl_trooper";
		displayname = "Trooper";
	...
	class bl_swla_unit_base: B_Soldier_02_f
	{
		scope = 1;
		scopeCurator = 1;
		scopeArsenal = 1;
	...
	class bl_swla_mc_unit_base: bl_swla_unit_base
	{
		...
		uniformClass="bl_swla_uniform_mc_base";
	};
	
	class B_Kitbag_rgr;
	class bl_swla_clone_backpack_base: B_Kitbag_rgr
	{
		author = "kripto202";
		scope = 0;
		picture="\SWLB_equipment\backpacks\data\ui\icon_SWLB_clone_backpack_ca.paa";
		displayName="[bl] Clone trooper backpack";
	...
	class bl_swla_clone_rto_backpack_base: bl_swla_clone_backpack_base
	{
		maximumload = 100;
		picture="\SWLB_equipment\backpacks\data\ui\icon_SWLB_clone_backpack_RTO_ca.paa";
		displayName="[bl] Clone trooper RTO backpack";
	...
	class bl_swla_clone_bag_base: bl_swla_clone_backpack_base
	{
		picture="\SWLB_equipment\backpacks\data\ui\icon_SWLB_clone_bag_ca.paa";
		displayName="[bl] Clone trooper bags";
