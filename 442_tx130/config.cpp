...
class cfgvehicles
{
	...
	class 442_tx130: rep_tx130
	{
		displayName="[LS] TX-130 Hover Tank";
		faction="442_siege_bat";
		editorSubcategory="442_ls_saber_tank";
		...
		hiddenSelectionsTextures[]=
		{
			"442_tx130\data\442_body.paa",
			"SWLG_clones_tanks\tx130\data\tx130_rocket_co.paa",
			"442_tx130\data\442_track.paa",
			"442_tx130\data\442_turret.paa"
		};
	};
};