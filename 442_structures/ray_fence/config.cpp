...
class cfgvehicles
{
    ...
    class k_fence_corner: House_f
    {
        ...
        model = "\kobra\442_structures\ray_fence\fence_corner.p3d";
    ...
    class k_fence_stand1: k_fence_corner
    {
        ...
        model = "\kobra\442_structures\ray_fence\fence_stand1.p3d";
    };
    class k_fence_stand2: k_fence_corner
    {
        displayname = "Fence Stand (End)";
        model = "\kobra\442_structures\ray_fence\fence_stand2.p3d";
    };
    class k_fence_ray_5m: k_fence_corner
    {
        displayname = "Ray (5m)";
        model = "\kobra\442_structures\ray_fence\ray_5m.p3d";
