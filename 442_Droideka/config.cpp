...
class cfgAmmo
{
	...
	class Droideka_ammo : BulletBase
	{
		...
		caliber = 3;
		cost = 1;
		model = "442_Droideka\data\tracer\Doublelaserred.p3d";
		tracerScale = 1;
		tracerStartTime = 0;
		timeToLive = 2;
		tracerEndTime = 3;
		...
		soundHit1[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact1.ogg",1.2,1,50};
		soundHit2[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact2.ogg",1.2,1,50};
		soundHit3[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact3.ogg",1.2,1,50};
		soundHit4[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact4.ogg",1.2,1,50};
		soundHit5[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact5.ogg",1.2,1,50};
		soundHit6[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact6.ogg",1.2,1,50};
		soundHit7[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact7.ogg",1.2,1,50};
		soundHit8[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact8.ogg",1.2,1,50};
		soundHit9[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact9.ogg",1.2,1,50};
		soundHit10[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact10.ogg",1.2,1,50};
		soundHit11[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact11.ogg",1.2,1,50};
		soundHit12[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact12.ogg",1.2,1,50};
		soundHit13[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact13.ogg",1.2,1,50};
		soundHit14[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact14.ogg",1.2,1,50};
		soundHit15[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact15.ogg",1.2,1,50};
		soundHit16[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact16.ogg",1.2,1,50};
		soundHit17[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact17.ogg",1.2,1,50};
		soundHit18[] = {"442_Droideka\data\Sounds\Heavyimpact\Heavyimpact18.ogg",1.2,1,50};
		...
		bulletFly1[] = {"442_Droideka\data\Sounds\flyby_close1.ogg",1.5848932,1,30};
		bulletFly2[] = {"442_Droideka\data\Sounds\flyby_close2.ogg",1.5848932,1,30};
		bulletFly3[] = {"442_Droideka\data\Sounds\flyby_close3.ogg",1.5848932,1,30};
		bulletFly4[] = {"442_Droideka\data\Sounds\flyby_close4.ogg",1.5848932,1,30};
		bulletFly5[] = {"442_Droideka\data\Sounds\flyby_close5.ogg",1.5848932,1,30};
		bulletFly6[] = {"442_Droideka\data\Sounds\flyby_close6.ogg",1.5848932,1,30};
		bulletFly7[] = {"442_Droideka\data\Sounds\flyby_close7.ogg",1.5848932,1,30};
		bulletFly8[] = {"442_Droideka\data\Sounds\flyby_close8.ogg",1.5848932,1,30};
		bulletFly9[] = {"442_Droideka\data\Sounds\flyby_close9.ogg",1.5848932,1,30};
		bulletFly10[] = {"442_Droideka\data\Sounds\flyby_close10.ogg",1.5848932,1,30};
		bulletFly11[] = {"442_Droideka\data\Sounds\flyby_close11.ogg",1.5848932,1,30};
		bulletFly12[] = {"442_Droideka\data\Sounds\flyby_close12.ogg",1.5848932,1,30};
		...
		supersonicCrackNear[] = {"442_Droideka\data\Sounds\Cracks\crack1.ogg",1,1,200};
		supersonicCrackFar[] = {"442_Droideka\data\Sounds\Cracks\crack2.ogg",1,1,200};
		class SuperSonicCrack
		{
		superSonicCrack[] = {"442_Droideka\data\Sounds\Cracks\crack3.ogg",3.1622777,1,200};
		class SCrackForest
		{
		range[] = {0,500};
...
class cfgWeapons
{
	...
	class Cannon_droideka: gatling_25mm
	{
		...
		class manual: Mode_FullAuto
		{
			...
			class StandardSound
			{
				begin1[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin2[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin3[] = {"442_Droideka\data\Sounds\droidekafire2.ogg",1,1,2000};
				begin4[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin5[] = {"442_Droideka\data\Sounds\droidekafire2.ogg",1,1,2000};
				begin6[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin7[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin8[] = {"442_Droideka\data\Sounds\droidekafire2.ogg",1,1,2000};
				begin9[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
				begin10[] = {"442_Droideka\data\Sounds\droidekafire1.ogg",1,1,2000};
...
class CfgVehicles
{
	...
	{
		model="442_Droideka\data\turret\droideka.p3d";
		...
		hiddenSelectionsTextures[] = {"442_Droideka\data\Textures\Droideka_CO.paa"};
		enableGPS = 1;
		radarType = 4;
		...
		class Damage
		{
			...
			mat[] = 
			{
				"442_Droideka\data\Textures\Droideka.rvmat",
				"442_Droideka\data\Textures\Droideka.rvmat",
				"442_Droideka\data\Textures\Droideka.rvmat",
				"442_Droideka\data\Textures\Droideka.rvmat",
				"442_Droideka\data\Textures\Droideka.rvmat",
	...
	{
		scope = 1;
		model = "442_Droideka\data\droideka.p3d";
		typicalCargo[] = {};
		irTarget = 0;
		transportAmmo = 0;
		transportRepair = 0;
