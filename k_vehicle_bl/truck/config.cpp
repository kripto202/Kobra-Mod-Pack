...
class cfgvehicles
{
    ...
    class 442_argon_transport_bl: 442_argon_transport
    {
        ...
        {
            "\kobra\k_vehicle_bl\truck\data\bl_truck_body.paa",
            "",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_cargo.paa"
        };
    };
    class 442_argon_covered_bl: 442_argon_covered
    {
        ...
        hiddenselectionstextures[] = 
        {
            ...
            "",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_cargo.paa",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_cover.paa"
        };
    };
    ...
    class 442_argon_fuel_bl: 442_argon_fuel
    {
        ...
        hiddenselectionstextures[] = 
        {
            "\kobra\k_vehicle_bl\truck\data\bl_truck_body.paa",
            "",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_fuel.paa"
        };
    };
    class 442_argon_repair_bl: 442_argon_repair
    {
        ...
        hiddenselectionstextures[] = 
        {
            "\kobra\k_vehicle_bl\truck\data\bl_truck_body.paa",
            "",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_repair.paa"
        };
    };
    class 442_argon_medical_bl: 442_argon_medical
    {
        ...
        hiddenselectionstextures[] = 
        {
            ...
            "",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_cargo.paa",
            "\kobra\k_vehicle_bl\truck\data\bl_truck_cover_m.paa"
        };
    };
};