class 442_clone_backpack: k_clone_backpack
	{
		...
		{
			"442_swla\data\backpacks\442_swla_backpack.paa",
			"4422_clones\data\backpack\cover_co.paa",
		};
	};
	class 442_clone_backpack_med: k_clone_backpack_med
	{
		...
		hiddenselectionstextures[] = 
		{
			"442_swla\data\backpacks\442_swla_backpack.paa",
			"4422_clones\data\backpack\cover_co.paa",
			"4422_clones\data\backpack\pouches_co.paa",
		};
	};
	class 442_clone_backpack_heavy: k_clone_backpack_heavy
	{
		...
		hiddenselectionstextures[] = 
		{
			...
			"4422_clones\data\backpack\cover_co.paa",
			"4422_clones\data\backpack\pouches_co.paa",
			"4422_clones\data\backpack\tube_co.paa",
		};
	};
	class 442_clone_backpack_medic: k_clone_backpack_medic
	{
		...
		hiddenselectionstextures[] = 
		{
			"442_swla\data\backpacks\442_swla_backpack.paa",
			"4422_clones\data\backpack\cover_co.paa",
			"4422_clones\data\backpack\medic_co.paa",
			"4422_clones\data\backpack\medic_co.paa",
		};
	};
	...
	class 442_clone_backpack_radio: k_clone_backpack_radio
	{
		...
		{
			"442_swla\data\backpacks\442_swla_backpack.paa",
			"4422_clones\data\backpack\radio_co.paa",
			"4422_clones\data\backpack\screen_co.paa",
		};
	};
	...
	class 442_clone_backpack_rocket: k_clone_backpack_rocket
	{
		...
		{
			"442_swla\data\backpacks\442_swla_backpack.paa",
			"4422_clones\data\backpack\holder_co.paa",
			"4422_clones\data\backpack\rocket_co.paa",
			"4422_clones\data\backpack\light_co.paa",
			"4422_clones\data\backpack\pouches_co.paa",
		};
	};