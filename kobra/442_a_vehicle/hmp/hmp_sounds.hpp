soundEngineOnInt[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_start.wss", 0.794328, 1};
soundEngineOnExt[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_start.wss", 0.794328, 1, 600};
soundEngineOffInt[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_end.wss", 0.794328, 1};
soundEngineOffExt[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_end.wss", 0.794328, 1, 600};
...
class sounds
{
	class EngineInt
	{
		sound[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_engine_1.wss", 1.25893, 1};
		frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
		volume = "2 * (1-camPos)*(rotorSpeed factor[0.4,1])";
	};
	class EngineExt
	{
		sound[] = {"kobra\442_a_vehicle\hmp\sounds\hmp_engine_2.wss", 1.25893, 1, 600};
		frequency = "rotorSpeed*(1+rotorThrust/6)*0.8";
